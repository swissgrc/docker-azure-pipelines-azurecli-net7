...
| unstable-net7 | Identical to `unstable` tag                                                                               | swissgrc/azure-pipelines-dotnet:7.0.405   | 2.56.0    | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-azurecli/unstable?style=flat-square)    |
